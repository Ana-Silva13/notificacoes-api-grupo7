...
## 1. Nome do Projeto
Nome do Prjeto: Notificação de API- Grupo 7 
...
A API automatiza o envio de e-mails de confirmação e lembretes para eventos, evitando erros e atrasos do processo manual.
Assim, melhora a organização, a eficiência e garante que os participantes recebam as informações no momento certo.
## 4. Escopo
### Incluído:
